const menu = [
  ...
  },
  {
    ...
    category: "Japan",
    price: 7.99,
    img: "https://assets.bonappetit.com/photos/6437281f4c497b684ece7ff3/1:1/w_2560%2Cc_limit/Recipe_Beauty_Gingery_Chicken_Ramen_0350.jpg",
...
const cuisineButtons = () => {
  let btns = cuisine
    .map((category) => {
      return `
        <button class="btn btn-item myBtn"> ${category} </button>`;
    })
    .join("");
